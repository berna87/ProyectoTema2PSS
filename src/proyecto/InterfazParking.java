...
public class InterfazParking {
	...
	private void initialize() {
		...
		//en el caso de que el usuario introduzca algo distinto de 1, 2 o 3 digitos el programa finalizar�
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(factorSalida<10){
					...
					lblSaleUnVehiculo.setText("Sale un veh�culo cada "+ factorSalida+" segundos");
					if(factorSalida==10){
